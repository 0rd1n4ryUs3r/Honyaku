...
<section class="products">
   ...
   <form action="" method="post" class="box">
      ...
      <div class="stock" style="font-size: 0.9rem; color: var(--text-muted); margin: 0.3rem 0;">Stock: <?php echo $fetch_product['stock']; ?></div>
      <input type="number"  class="qty" name="product_quantity" min="1" max="<?php echo $fetch_product['stock']; ?>" value="1" <?php echo $fetch_product['stock'] == 0 ? 'disabled' : ''; ?>>
      <input type="hidden" name="product_name" value="<?php echo $fetch_product['name']; ?>">
      <input type="hidden" name="product_price" value="<?php echo $fetch_product['price']; ?>">
      <input type="hidden" name="product_image" value="<?php echo $fetch_product['image']; ?>">
      <input type="submit" class="btn" value="add to cart" name="add_to_cart" <?php echo $fetch_product['stock'] == 0 ? 'disabled' : ''; ?>>
   </form>
   <?php
            }
         }else{
